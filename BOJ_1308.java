...
public class BOJ_1308 {
    ...
    static int[] day(int year) {
        ...
        if ((year % 4 == 0 && year % 100 != 0) || year % 400 == 0) { // 윤년 조건 수정
            month_days[1] = 29;
        }
        return month_days;
    }
    ...
    public static void main(String[] args) {
        ...
        // is gg
        if ((d_y - today_y > 1000) ||
                (d_y - today_y == 1000 && d_m > today_m) ||
                (d_y - today_y == 1000 && d_m == today_m && d_d >= today_d)) {
            System.out.println("gg");
        } else {
            int t = sum_days(today_y, today_m, today_d);
            int d = sum_days(d_y, d_m, d_d);
